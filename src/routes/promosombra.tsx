    ...
    <div className="bg-[#fafafa] text-[#1a1a1a] font-sans relative overflow-x-hidden min-h-screen">
          ...
          <motion.div initial={{ opacity: 1, x: 0 }} animate={{ opacity: 1, x: 0 }}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start items-center">
              ...
              <div className="bg-black/20 backdrop-blur-md px-8 py-5 rounded-3xl border border-white/20">
                ...
                <p className="text-4xl font-black tracking-tighter text-yellow-300">R$ 40</p>
      ...
      <section className="bg-black text-white py-32 px-6 overflow-hidden relative z-20">
        <div className="container mx-auto text-center">
          ...
          <p className="text-3xl md:text-5xl font-black mt-24 uppercase italic tracking-tighter text-white">Acesso Vitalício: <span className="line-through text-white/40 text-2xl md:text-3xl">De R$ 197</span> <span className="text-[#d82298]">R$ 40,00</span></p>
          <div className="mt-10">
            <PulseButton className="inline-block py-5 px-10 rounded-full text-lg md:text-xl">
              GARANTIR MEUS BÔNUS →
            </PulseButton>
          ...
          <div className="grid md:grid-cols-1 gap-6 max-w-xl mx-auto">
            <div className="bg-white text-[#1a1a1a] rounded-[2.5rem] p-8 shadow-2xl border-4 border-yellow-300 flex flex-col">
              ...
              <div className="flex items-start justify-center gap-1 my-3">
                ...
                <span className="text-7xl font-black text-[#d82298] leading-none tracking-tighter">40</span>
              </div>
...
function CheckoutModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const base = 40;
  const extras = (bumpAlisamento ? 19 : 0) + (bumpCilios ? 39 : 0) + (bumpVitalicio ? 9 : 0);
              ...
              <div className="pt-2">
                ...
                <div className="flex items-start gap-3 p-3 rounded-xl border-2 border-[#d82298] bg-gradient-to-br from-pink-50 to-fuchsia-50">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-600">Acesso vitalício + certificado MEC · <strong className="text-[#d82298]">R$ 40</strong></p>
                  </div>
                </div>
              </div>
