...
import cabelereiraProCoverAsset from "@/assets/cover-cabelereira-pro-2027-v2.jpg.asset.json";
const cabelereiraProCover = cabelereiraProCoverAsset.url;
const heroCabelereira = cabelereiraProCover;
