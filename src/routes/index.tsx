...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-gray-900 overflow-x-hidden font-sans">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-12 px-6 overflow-hidden bg-gradient-to-br from-[#d82298] via-[#e945a9] to-[#b01b7a]">
