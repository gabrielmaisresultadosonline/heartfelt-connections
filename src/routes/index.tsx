...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-gray-900 font-sans relative">
      ...
      {/* Hero Section */}
      <section style={{ zIndex: 9999 }} className="relative min-h-[100vh] flex items-center justify-center pt-32 pb-12 px-6 overflow-hidden bg-gradient-to-br from-[#d82298] via-[#e945a9] to-[#b01b7a]">
